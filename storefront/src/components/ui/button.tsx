...
function Button({
  ...
  // When using asChild, we can't add the loader as it would create multiple children
  // So we just pass through the children - the parent needs to handle loading state
  if (asChild) {
    return (
      <Slot
        data-slot="button"
