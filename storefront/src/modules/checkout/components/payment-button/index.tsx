...
const StripePaymentButton = ({
  ...
  const handlePayment = async () => {
    ...
    // Conferma il pagamento utilizzando il PaymentElement
    ...
    if (error) {
      // Errore durante la conferma del pagamento
      setErrorMessage(error.message || null)
      setSubmitting(false)
      return
    }

    // Se il pagamento non richiede reindirizzamento, completa l'ordine
