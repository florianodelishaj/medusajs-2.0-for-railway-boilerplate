    ...
    >
      <Popover className="relative h-full">
        ...
        >
          <Popover.Panel
            static
            className="hidden small:block absolute top-full right-4 w-[440px] text-black"
            data-testid="nav-cart-dropdown"
          >
            {/* Hover bridge covering the gap */}
            <div className="h-2" />

            <div className="bg-white border rounded-md border-black shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
              {/* <div className="p-4 flex items-center justify-center border-b-2 border-black bg-pink-400">
                <h3 className="text-lg font-bold uppercase tracking-wide">Carrello</h3>
              </div> */}
              {cartState && cartState.items?.length ? (
                <>
                  <div className="overflow-y-scroll max-h-[402px] p-4 grid grid-cols-1 gap-y-4 no-scrollbar">
                    {cartState.items
                      .sort((a, b) => {
